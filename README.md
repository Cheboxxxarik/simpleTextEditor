...
| Название цвета | RGB | Совместимость / Примечания |
| :--- | :--- | :--- |
| **Темно-оранжевый** | `158, 94, 21` | Хорошо сочетается со светлыми темами + GruvboxDark |
| **Оливково-зеленый** | `58, 94, 21` | Хорошо сочетается со светлыми темами + GruvboxDark |
...
| **Насыщенно-пурпурно-синий** | `71, 67, 137` | Хорошо сочетается с Catppuccin Mocha |
...
> *Ветка `prebuilt-app` была создана для поддержки старых версий приложения, но больше не актуальна и не получает обновлений.*
### Создание тем
...
1. Контрастность: Убедитесь, что `text_color` (`window_text_color`) и `background_color` имеют достаточный контраст
